...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground pb-24 relative overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-md mx-auto flex flex-col gap-4 mb-24">
        {/* Unified Hero Section */}
        <section className="bg-gradient-to-br from-primary to-secondary rounded-b-[3rem] p-6 shadow-xl relative overflow-hidden text-primary-foreground mb-4">
          <Header />
          <PrayerTimes />
        </section>
        {/* Quick Menu */}
